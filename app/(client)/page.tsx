    ...
    <div className="flex flex-col min-h-screen">
        ...
        <div className="relative min-h-[600px] sm:min-h-[640px] lg:min-h-[680px] flex items-center">
          ...
          <div className="relative z-10 w-full mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-28 lg:pt-30 pb-28 sm:pb-32 lg:pb-34">
            <div className="w-full max-w-5xl mx-auto text-center">
              <h1 className="mx-auto max-w-4xl text-[2.15rem] sm:text-[2.65rem] lg:text-[3.1rem] font-extrabold tracking-[-0.025em] leading-[1.05] text-white">
                Find the car of your dreams at
                <span className="block mt-0.5">ICar Gezina</span>
              </h1>
              <p className="mx-auto mt-3 sm:mt-4 w-full max-w-4xl text-[13px] sm:text-sm lg:text-base leading-5 sm:leading-6 text-white/95">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="mt-8 flex justify-center md:hidden"><Link href="/cars" className="bg-[#0072BC] px-6 py-3 rounded-lg text-white font-bold text-sm hover:bg-[#005F9E] transition">View All Inventory</Link></div>
        </div>
      </section>
